...
public class SysValues {	//TODO: Change all these from hardcoded? Load from text file perhaps?
	...
	public final static int redundancylevel = 3;			// Store data on n servers. This includes the first server to be mapped to! So a value of 1 is "not redundant".
	...
	public final static Boolean ShowValues = true;			// Enable or disable socket read output to stdout (lots of spam)
